...
def index():
    ...
    linea5 = u'The total figure for oil reserves, including the Strategic Reserves, {} a total of {0:,g} million barrels, a {} percent change versus the previous week'.format(verb,totalreservas,reservaschange)
